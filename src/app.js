...
const pool = require('./db');                    // Koneksi database yang sudah dibuat sebelumnya

// Impor File Rute (Routing)
const apiRoutes = require('./routes');                // Menangani API (Data JSON)
const webhookRoutes = require('./routes/webhook.routes'); // Menangani callback/webhook dari pihak ketiga
